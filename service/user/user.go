...
type IUserService interface {
	BrowseUser(params dto.BrowseUserRequest) response.ServiceResult
	DetailUser(id int64) response.ServiceResult
	CreateUser(params dto.CreateUserRequest) response.ServiceResult
	UpdateUser(params dto.UpdateUserRequest) response.ServiceResult
	UpdateUserPassword(params dto.UpdateUserPasswordRequest) response.ServiceResult
	DeleteUser(params dto.DeleteUserRequest) response.ServiceResult
}
